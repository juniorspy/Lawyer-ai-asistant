...
<body>
    <div class="container">
        ...
        <form action="{{ route('contrato.compra-venta.step2.post') }}" method="POST">
            @csrf
            ...
            <div class="radio-group">
                <label>
                    <input type="radio" name="sexo" value="Masculino" checked onchange="updateEstadoCivil()"> Masculino
                </label>
                <label>
                    <input type="radio" name="sexo" value="Femenino" onchange="updateEstadoCivil()"> Femenino
                </label>
            </div>
            ...
            <!-- Row 6: Ciudad y País (Vendedor) -->
            <div class="form-group">
                <div>
                    <input type="text" id="vendedor_ciudad" name="vendedor_ciudad" placeholder="Ciudad" required>
                </div>
                <div>
                    <input type="text" id="vendedor_pais" name="vendedor_pais" value="República Dominicana" required>
                </div>
            </div>

            <!-- Custom Fields Section -->
            <div class="custom-fields-container">
                <p>Agregar Campo Personalizado:</p>
                <div class="form-group">
            ...
            <div class="button-group">
                <a href="{{ route('contrato.compra-venta.step1') }}" class="btn btn-back">Atrás</a>
